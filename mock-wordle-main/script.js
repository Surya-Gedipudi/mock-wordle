...
function startNewGame() {
    ...
    maxGuesses = word.length >= 5 ? 12 : 9; // Setting the maximum number of guesses based on word length; if word chars/letters >= 5, then max guess is 8. If word chars/letters < 5, max guess is 6.
...
if (storedColor) {
    document.body.style.backgroundColor = storedColor; // If a color is stored(storedColor is truthy/conditional is met) --> sets the background color of the page to the stored color (value in variable)
} else {
